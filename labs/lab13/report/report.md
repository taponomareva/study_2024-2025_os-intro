...
Эти скрипты выполняют различные операции в командной оболочке UNIX/Linux: анализируют аргументы командной строки, создают и удаляют файлы, а также пакуют файлы, изменённые за последнюю неделю.
